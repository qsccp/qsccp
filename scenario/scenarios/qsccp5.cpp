...
namespace ns3
{
    ...
    main(int argc, char *argv[])
    {
        ...
        ndn::L3RateTracer::InstallAll("qsccp-throughput.txt", Seconds(0.1));
        ndn::AppDelayTracer::InstallAll("qsccp-delay.txt");
        L2RateTracer::InstallAll("qsccp-drop.txt", Seconds(0.1));
        Simulator::Run();
        Simulator::Destroy();
