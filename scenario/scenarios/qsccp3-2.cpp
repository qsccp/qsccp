...
namespace ns3
{
    ...
    main(int argc, char *argv[])
    {
        ...
        ndn::L3RateTracer::InstallAll("qsccp-throughput-3-2.txt", Seconds(0.5));
        ndn::AppDelayTracer::InstallAll("qsccp-delay-3-2.txt");
        L2RateTracer::InstallAll("qsccp-drop-3-2.txt", Seconds(0.5));
        Simulator::Run();
        Simulator::Destroy();
