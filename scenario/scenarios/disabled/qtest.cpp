...
namespace ns3
{
    ...
    main(int argc, char *argv[])
    {
        ...
        ndn::L3RateTracer::InstallAll("qtest-throughput-s1.txt", Seconds(0.5));
        ndn::AppDelayTracer::InstallAll("qtest-delay-s1.txt");
        L2RateTracer::InstallAll("qtest-drop-s1.txt", Seconds(0.5));
        Simulator::Run();
        Simulator::Destroy();
