...
namespace ns3
{
    ...
    main(int argc, char *argv[])
    {
        ...
        ndn::L3RateTracer::InstallAll("qsccp-multi-throughput.txt", Seconds(0.1));
        ndn::AppDelayTracer::InstallAll("qsccp-multi-delay.txt");
        L2RateTracer::InstallAll("qsccp-multi-drop.txt", Seconds(0.1));
        Simulator::Run();
        Simulator::Destroy();
