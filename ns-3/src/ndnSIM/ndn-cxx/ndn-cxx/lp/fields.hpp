 ...
 */
typedef FieldDecl<field_location_tags::Header,
        uint64_t, tlv::DSZ> DSZField;
BOOST_CONCEPT_ASSERT((Field<DSZField>));

/**
 * Tos Field
 */
typedef FieldDecl<field_location_tags::Header,
        uint64_t, tlv::Tos> TosField;
BOOST_CONCEPT_ASSERT((Field<TosField>));

/**
 * Fair rate field
 */
typedef FieldDecl<field_location_tags::Header,
        uint64_t, tlv::TargetRate> TargetRateField;
BOOST_CONCEPT_ASSERT((Field<TargetRateField>));

///**
// * Queue occupy rate
// */
//typedef FieldDecl<field_location_tags::Header,
//        uint64_t, tlv::QueueOccupyRate> QueueOccupyRateField;
//BOOST_CONCEPT_ASSERT((Field<QueueOccupyRateField>));

/**
 * Available rate field
 */
typedef FieldDecl<field_location_tags::Header,
        uint64_t, tlv::DownstreamRate> DownstreamRateField;
BOOST_CONCEPT_ASSERT((Field<DownstreamRateField>));
