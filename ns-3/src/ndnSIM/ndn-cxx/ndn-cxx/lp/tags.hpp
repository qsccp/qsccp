 ...
 * Data Size
 */
typedef SimpleTag<uint64_t, 16> DSZTag;

/**
 * Tos
 */
typedef SimpleTag<uint64_t, 17> TosTag;

/**
 * Fair rate tag
 */
typedef SimpleTag<uint64_t, 18> TargetRateTag;

///**
// * Queue occupy rate（0 ~ 100）
// */
//typedef SimpleTag<uint64_t, 19> QueueOccupyRateTag;

/**
 * Available Rate tag
 */
typedef SimpleTag<uint64_t, 19> DownstreamRateTag;
